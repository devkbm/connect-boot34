...
CREATE TABLE COMCOMPANY_AUD (    
	...
	ORG_NM			    	VARCHAR(100)		NOT NULL	,  	
  	...
  	BIZ_ITEM_NM				VARCHAR(500)		NULL		,
  	ESTA_DT				    DATETIME			NULL        ,  	
	constraint pk_comcompany_aud primary key(REV,ORG_CD)	    
);
COMMENT ON TABLE COMCOMPANY_AUD IS '회사정보_히스토리';
...
CREATE TABLE COMUSER_AUD (
	...
	USER_NAME			    VARCHAR(100)		NULL		,  	
  	...
  	PASS_NON_EXPIRED_YN		BOOLEAN			  	NOT NULL	,
  	ENABLED_YN			    BOOLEAN			  	NOT NULL	,
	constraint pk_comuser_aud primary key(REV, USER_ID)
	--constraint fk_comuser1	foreign key(FK_FILE) references COMFILEINFO(PK_FILE)
);
COMMENT ON TABLE COMUSER_AUD IS '사용자정보_히스토리';
...
CREATE TABLE COMUSERCOMPANY_AUD (
	REV 					INTEGER 			NOT NULL  	,
    REVTYPE 				TINYINT				NULL		,
	CREATED_DT			    DATETIME		  	NULL		,
	CREATED_USER_ID		  	VARCHAR(50)			NULL		,
	...
	DEPT_CD				    VARCHAR(10) 		NULL 		,		
  	USE_YN			   		BOOLEAN			  	NOT NULL	,
	constraint pk_comusercompany_aud primary key(REV, USER_ID, ORG_CD)
	--constraint fk_comuser1	foreign key(FK_FILE) references COMFILEINFO(PK_FILE)
);
COMMENT ON TABLE COMUSERCOMPANY_AUD IS '사용자회사정보_히스토리';
...
CREATE TABLE COMUSERROLE_AUD (
	...
	MODIFIED_APP_URL		VARCHAR(500)		NULL		,  	
  	...
  	ROLE_CD				    VARCHAR(50)			NOT NULL	,
  	ORG_CD				    VARCHAR(50)			NOT NULL	,  	
	constraint pk_comuserrole_aud 	primary key(USER_ID, ROLE_CD, ORG_CD)	
); 
COMMENT ON TABLE COMUSERROLE_AUD IS '사용자권한매핑관_히스토리';
